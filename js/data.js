var data = {
  ...
  intro: `QA Tester con 3+ año de experiencia como tester manual de aplicaciones web y móviles, ayudo a compañías a desarrollar un producto prolijo con una UX píxel perfecto y rendimiento que exceda los estándares de calidad de corporaciones internacionales.`,
  birthdate:   '05/02/1995 -- Barcelona-España',
  address:    'Carrer de la Boqueria, 26 08002',
  phone:      '(+34) 622-51-16-28',
  email:      'nanettsandoval95@gmail.com',
  github:     'github.com/nanett95',
  ...
  education: [
    {
      ...
      where: 'Udemy',
      skills: ['html','css','diseño','maquetación','desarrollo web']
    },
    {
      date:  '2019',
      title: 'QA Tester Manual',
      where: 'Udemy',
      skills:['Jira','API Testing','Scrum','Kanban']
    },
    {
      date:  '2012-2016',
      title: 'Técnico Superior de Citotecnología',
      where: 'Universidad de Carabobo',
      icon:'diploma',
    }
  ],

  motherLanguage: 'Español',
  all_skills: [
    'javascript',
    'nodejs',
    'html',
